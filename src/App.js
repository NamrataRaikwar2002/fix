...
var musicSong = {
  classical: [
    ...
    { name: "Elgar - Salut d'amour", rating: "4/5" },
    { name: "Muse: The Globalist ", rating: "4.5/5" }
  ],
  pop: [
    { name: "Rolling in the Deep", rating: "5/5" },
    { name: "Firework", rating: "4.5/5" },
    { name: "ReHab", rating: "4/5" },
    { name: "Umbrella", rating: "3.5/5" }
  ],
  hiphop: [
    { name: "MONTERO (Call Me By Your Name)", rating: "4.5/5" },
    { name: "Panda", rating: "5/5" },
    { name: "Reminder", rating: "4.5/5" },
    { name: "Welcome to the party", rating: "4.5/5" }
  ]
};
